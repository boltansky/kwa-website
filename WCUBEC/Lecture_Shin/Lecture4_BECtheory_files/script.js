...
var gDocTable = new Array(
   new hrefList("slide0025.htm", 1, 1),
   new hrefList("slide0026.htm", 1, 2),
   new hrefList("slide0027.htm", 1, 3),
   new hrefList("slide0028.htm", 1, 4),
   new hrefList("slide0029.htm", 1, 5),
   new hrefList("slide0030.htm", 1, 6),
   new hrefList("slide0031.htm", 1, 7),
   new hrefList("slide0032.htm", 1, 8),
   new hrefList("slide0033.htm", 1, 9),
   new hrefList("slide0034.htm", 1, 10),
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Lecture4_BECtheory_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Lecture4_BECtheory_files/error.htm" );
	}
	else {
