...
var gDocTable = new Array(
   ...
   new hrefList("slide0031.htm", 1, 3),
   ...
   new hrefList("slide0037.htm", 1, 9),
   new hrefList("slide0038.htm", 1, 10),
   new hrefList("slide0039.htm", 1, 11),
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Lecture6_PhaseCoherence_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Lecture6_PhaseCoherence_files/error.htm" );
	}
	else {
