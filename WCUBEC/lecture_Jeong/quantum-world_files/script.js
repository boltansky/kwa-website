...
var gDocTable = new Array(
   new hrefList("slide0115.htm", 1, 1),
   new hrefList("slide0116.htm", 1, 2),
   new hrefList("slide0117.htm", 1, 3),
   new hrefList("slide0118.htm", 1, 4),
   new hrefList("slide0119.htm", 1, 5),
   new hrefList("slide0120.htm", 1, 6),
   new hrefList("slide0121.htm", 1, 7),
   new hrefList("slide0122.htm", 1, 8),
   new hrefList("slide0123.htm", 1, 9),
   new hrefList("slide0124.htm", 1, 10),
   new hrefList("slide0125.htm", 1, 11),
   new hrefList("slide0126.htm", 1, 12),
   new hrefList("slide0127.htm", 1, 13),
   new hrefList("slide0128.htm", 1, 14),
   new hrefList("slide0129.htm", 1, 15),
   new hrefList("slide0130.htm", 1, 16),
   new hrefList("slide0131.htm", 1, 17),
   new hrefList("slide0132.htm", 1, 18),
   new hrefList("slide0133.htm", 1, 19),
   new hrefList("slide0134.htm", 1, 20),
   new hrefList("slide0135.htm", 1, 21),
   new hrefList("slide0136.htm", 1, 22),
   new hrefList("slide0137.htm", 1, 23),
   new hrefList("slide0138.htm", 1, 24),
   new hrefList("slide0139.htm", 1, 25),
   new hrefList("slide0140.htm", 1, 26),
   new hrefList("slide0141.htm", 1, 27),
   new hrefList("slide0142.htm", 1, 28),
   new hrefList("slide0143.htm", 1, 29),
   new hrefList("slide0144.htm", 1, 30),
   new hrefList("slide0145.htm", 1, 31),
   new hrefList("slide0146.htm", 1, 32),
   new hrefList("slide0147.htm", 1, 33),
   new hrefList("slide0148.htm", 1, 34),
   new hrefList("slide0149.htm", 1, 35),
   new hrefList("slide0150.htm", 1, 36),
   new hrefList("slide0151.htm", 1, 37),
   new hrefList("slide0152.htm", 1, 38),
   new hrefList("slide0153.htm", 1, 39),
   new hrefList("slide0154.htm", 1, 40),
   new hrefList("slide0155.htm", 1, 41),
   new hrefList("slide0156.htm", 1, 42),
   new hrefList("slide0157.htm", 1, 43),
   new hrefList("slide0158.htm", 1, 44),
   new hrefList("slide0159.htm", 1, 45),
   new hrefList("slide0160.htm", 1, 46),
   new hrefList("slide0161.htm", 1, 47),
   new hrefList("slide0162.htm", 1, 48),
   new hrefList("slide0163.htm", 1, 49),
   new hrefList("slide0164.htm", 1, 50),
   new hrefList("slide0165.htm", 1, 51),
   new hrefList("slide0166.htm", 1, 52),
   new hrefList("slide0167.htm", 1, 53),
   new hrefList("slide0168.htm", 1, 54),
   new hrefList("slide0169.htm", 1, 55),
   new hrefList("slide0170.htm", 1, 56),
   new hrefList("slide0171.htm", 1, 57)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "quantum-world_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "quantum-world_files/error.htm" );
	}
	else {
