...
var gDocTable = new Array(
   new hrefList("slide0159.htm", 1, 1),
   new hrefList("slide0160.htm", 1, 2),
   new hrefList("slide0161.htm", 1, 3),
   new hrefList("slide0162.htm", 1, 4),
   new hrefList("slide0163.htm", 1, 5),
   new hrefList("slide0164.htm", 1, 6),
   new hrefList("slide0165.htm", 1, 7),
   new hrefList("slide0166.htm", 1, 8),
   new hrefList("slide0167.htm", 1, 9),
   new hrefList("slide0168.htm", 1, 10),
   new hrefList("slide0169.htm", 1, 11),
   new hrefList("slide0170.htm", 1, 12),
   new hrefList("slide0171.htm", 1, 13),
   new hrefList("slide0172.htm", 1, 14),
   new hrefList("slide0173.htm", 1, 15),
   new hrefList("slide0174.htm", 1, 16),
   new hrefList("slide0175.htm", 1, 17),
   new hrefList("slide0176.htm", 1, 18),
   new hrefList("slide0177.htm", 1, 19),
   new hrefList("slide0178.htm", 1, 20),
   new hrefList("slide0179.htm", 1, 21),
   new hrefList("slide0180.htm", 1, 22),
   new hrefList("slide0181.htm", 1, 23),
   new hrefList("slide0182.htm", 1, 24),
   new hrefList("slide0183.htm", 1, 25),
   new hrefList("slide0184.htm", 1, 26),
   new hrefList("slide0185.htm", 1, 27),
   new hrefList("slide0186.htm", 1, 28),
   new hrefList("slide0187.htm", 1, 29),
   new hrefList("slide0188.htm", 1, 30),
   new hrefList("slide0189.htm", 1, 31),
   new hrefList("slide0190.htm", 1, 32),
   new hrefList("slide0191.htm", 1, 33),
   new hrefList("slide0192.htm", 1, 34),
   new hrefList("slide0193.htm", 1, 35),
   new hrefList("slide0194.htm", 1, 36),
   new hrefList("slide0195.htm", 1, 37),
   new hrefList("slide0196.htm", 1, 38),
   new hrefList("slide0197.htm", 1, 39),
   new hrefList("slide0198.htm", 1, 40),
   new hrefList("slide0199.htm", 1, 41),
   new hrefList("slide0200.htm", 1, 42),
   new hrefList("slide0201.htm", 1, 43),
   new hrefList("slide0202.htm", 1, 44),
   new hrefList("slide0203.htm", 1, 45),
   new hrefList("slide0204.htm", 1, 46),
   new hrefList("slide0205.htm", 1, 47),
   new hrefList("slide0206.htm", 1, 48),
   new hrefList("slide0207.htm", 1, 49),
   new hrefList("slide0208.htm", 1, 50),
   new hrefList("slide0209.htm", 1, 51),
   new hrefList("slide0210.htm", 1, 52),
   new hrefList("slide0211.htm", 1, 53),
   new hrefList("slide0212.htm", 1, 54),
   new hrefList("slide0213.htm", 1, 55),
   new hrefList("slide0214.htm", 1, 56),
   new hrefList("slide0215.htm", 1, 57),
   new hrefList("slide0216.htm", 1, 58),
   new hrefList("slide0217.htm", 1, 59),
   new hrefList("slide0218.htm", 1, 60),
   new hrefList("slide0219.htm", 1, 61),
   new hrefList("slide0220.htm", 1, 62),
   new hrefList("slide0221.htm", 1, 63),
   new hrefList("slide0222.htm", 1, 64),
   new hrefList("slide0223.htm", 1, 65),
   new hrefList("slide0224.htm", 1, 66),
   new hrefList("slide0225.htm", 1, 67),
   new hrefList("slide0226.htm", 1, 68),
   new hrefList("slide0227.htm", 1, 69),
   new hrefList("slide0228.htm", 1, 70),
   new hrefList("slide0229.htm", 1, 71),
   new hrefList("slide0230.htm", 1, 72),
   new hrefList("slide0231.htm", 1, 73),
   new hrefList("slide0232.htm", 1, 74),
   new hrefList("slide0233.htm", 1, 75),
   new hrefList("slide0234.htm", 1, 76),
   new hrefList("slide0235.htm", 1, 77),
   new hrefList("slide0236.htm", 1, 78),
   new hrefList("slide0237.htm", 1, 79)
);
...
var sNext="Next",sPrev="Previous",sEnd="End Show",sFont="&#65325;&#65331; &#65328;&#12468;&#12471;&#12483;&#12463;", alwaysOn = false
function ShowMenu()
{
	BuildMenu();
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Measurement-and-Decoherence_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Measurement-and-Decoherence_files/error.htm" );
	}
	else {
