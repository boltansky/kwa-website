...
var gDocTable = new Array(
   ...
   new hrefList("slide0021.htm", 1, 3),
   ...
   new hrefList("slide0027.htm", 1, 9)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "AMP20_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "AMP20_files/error.htm" );
	}
	else {
