...
var gDocTable = new Array(
   ...
   new hrefList("slide0046.htm", 1, 2),
   new hrefList("slide0047.htm", 1, 3),
   new hrefList("slide0048.htm", 1, 4),
   new hrefList("slide0049.htm", 1, 5),
   new hrefList("slide0050.htm", 1, 6),
   new hrefList("slide0051.htm", 1, 7),
   new hrefList("slide0052.htm", 1, 8),
   new hrefList("slide0053.htm", 1, 9),
   new hrefList("slide0054.htm", 1, 10),
   new hrefList("slide0055.htm", 1, 11),
   new hrefList("slide0056.htm", 1, 12),
   new hrefList("slide0057.htm", 1, 13),
   new hrefList("slide0058.htm", 1, 14),
   new hrefList("slide0059.htm", 1, 15),
   new hrefList("slide0060.htm", 1, 16),
   new hrefList("slide0061.htm", 1, 17),
   new hrefList("slide0062.htm", 1, 18),
   new hrefList("slide0063.htm", 1, 19),
   new hrefList("slide0064.htm", 1, 20),
   new hrefList("slide0065.htm", 1, 21),
   new hrefList("slide0066.htm", 1, 22)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "spot-check-BEC-2010_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "spot-check-BEC-2010_files/error.htm" );
	}
	else {
