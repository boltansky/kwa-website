...
var sNext="Next",sPrev="Previous",sEnd="End Show",sFont="‚l‚r ‚oƒSƒVƒbƒN", alwaysOn = false
function ShowMenu()
{
	BuildMenu();
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "AMP24_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "AMP24_files/error.htm" );
	}
	else {
